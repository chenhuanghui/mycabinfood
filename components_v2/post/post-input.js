...
import ImageAttachment from "../../components_v2/attachment/image-attachment"
...
export default class PostInput extends React.Component {
    ...
    componentDidMount() {
        ...
        $(".btn-action-post").click(function(){
            ...
            createPost(postContent, postAttachment, currentComponent.props.brand, currentComponent.props.user)
            .then(res => {
